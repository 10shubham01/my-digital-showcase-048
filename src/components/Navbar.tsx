...
const Navbar = () => {
  return (
    <motion.nav
      ...
      className="fixed top-5 left-0 right-0 z-30 flex items-center justify-between px-6 md:px-12 py-5 bg-background/80 backdrop-blur-md border-b border-border">
