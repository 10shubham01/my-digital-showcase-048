...
const Hero = () => {
  return (
    <section className="min-h-screen flex flex-col justify-center px-6 md:px-12 lg:px-24 pt-20 relative">
      {/* Ambient glow */}
      ...
      <div className="max-w-5xl relative">
        ...
        <h1 className="font-heading text-5xl md:text-7xl lg:text-8xl font-normal leading-[0.95] tracking-tight text-foreground mb-8">
