...
const experiences = [
  ...
  },
  {
    ...
    tech: ["Vue.js", "Nuxt.js", "Node.js", "PostgreSQL", "Adonis.JS"],
    projects: [
      {
        title: "Admin Portal",
        description:
    ...
    >
      ...
      <div className="flex flex-wrap gap-2 mb-6">
        {tech.map((t) => (
          <span
            key={t}
            className="text-xs font-body text-muted-foreground border border-border px-2.5 py-1 hover:text-foreground hover:border-foreground/30 transition-colors"
          >
            {t}
          </span>
        ))}
              ...
              >
                ...
                <div className="flex flex-wrap gap-1.5">
                  {project.tech.map((t) => (
                    <span
                      key={t}
                      className="text-[10px] font-body text-muted-foreground border border-border px-2 py-0.5"
                    >
                      {t}
                    </span>
                  ))}
